        ...
        return (
            <div className="w-auto h-16 flex items-center  p-4 bg-[rgb(23,20,33)]">
                <div className="flex items-center space-x-4 pl-[20rem]">
                    ...
                    <div className="flex items-center space-x-4 pl-[20rem]">
                        <div className="w-auto flex items-center bg-white h-full px-4 py-2 rounded-full">
                            <CiGift />
                        </div>
                    </div>
                    ...
                    <div className="ml-4 flex">
                        <button
                            ...
                            className="bg-purple-600 text-white flex items-center gap-2 px-4 py-2 rounded hover:bg-purple-700" >
                            Sign up
                            <FaArrowRight />
                        </button>
                    </div>
